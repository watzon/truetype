module TrueType
  module Tables
    module Color
      ...
      # The 'CBLC' table (Color Bitmap Location) provides location info for bitmap glyph data
      # stored in the CBDT table. Used for color emoji fonts.
      class CBLC
        include IOHelpers
        ...
        # Parse CBLC table from raw bytes
        def self.parse(data : Bytes) : CBLC
